        ...
        async (err, result) => {
            if (err) {
                ...
                if (result.length === 1) {
                    ...
                    live.push({token,socketid:socket.id});
...
io.on("connection", (socket) => {
    ...
    socket.on("receive_message_sub", (data) => {
        ...
        // }
        db.query(
            `SELECT * FROM period ORDER BY id DESC LIMIT 21`,
            (err, result) => {
                if (err) {
...
setInterval(async () => {
    ...
    const timePlue = nowDate + 1000 * 30;
    const d = new Date();
    ...
    db.query(`SELECT * FROM counttime WHERE id='2'`, (err, result) => {
        if (result) {
            ...
            const FinalPeriod = (timestamp / 1000 - timestamps / 1000) / 30;
             ...
             const incresePeriod = timep + parseInt(FinalPeriod);
                ...
                (err, result) => {
                    if (result) {
                        ...
                        const rever = resultArray.reverse();
                         ...
                         db.query(
                            `SELECT * FROM orders WHERE period=${rever[1]?.period}`,
                            (err, result) => {
                                if (result) {
                                                            ...
                                                            const winners =
                                                                winnerRendom == 0
                                                                    ...
                                                                    : winnerRendom == 1
                                                                        ...
                                                                        : "tie";
                                                            db.query(
                                                                `SELECT * FROM winner WHERE period="${rever[1]?.period}"`,
                                                                (err, result) => {
                                                                    if (result) {
                                                                        if (result?.length == 0) {
                                                                            db.query(
                                                                                `UPDATE  orders SET win='${winners}'   WHERE Period = "${rever[1]?.period}" `,
                                                                                (err, result) => {
                                                                                    if (err) {
                                                                                    } else {
                                                                                        // console.log("ryt");
                                                                            ...
                                                                            db.query(
                                                                                `UPDATE  period SET win='${winners}'  WHERE Period = "${rever[1]?.period}"`,
                                                                                (err, result) => {
                                                                                    if (err) {
                                                                                        //    console.log(err);
                                                                                    } else {
                                                    ...
                                                    db.query(
                                                        ...
                                                        (err, result) => {
                                                            if (result) {
                                                                if (result?.length == 0) {
                                                                    db.query(
                                                                        `UPDATE  orders SET win='${winner}'   WHERE Period = ${rever[1]?.period} `,
                                                                        (err, result) => {
                                                                            if (err) {
                                                                                console.log(err);
                                                                            } else {
                                                                    ...
                                                                    db.query(
                                                                        `UPDATE  period SET win='${winner}'  WHERE Period = ${rever[1]?.period}`,
                                                                        (err, result) => {
                                                                            if (err) {
                                                                            } else {
...
app.post("/gamesetting", (req, res) => {
    const { endid, win, loss ,tie} =req.body;
        ...
        const diff=endid-startid;
              ...
              var winner=finaltimes[i]
                ...
                nextoutcomes.push({periodId:startid,winner:winner});
    ...
    db.query(
        ...
        (err, result) => {
            if (err) {
                res.status(200).json({ mess: "Failed", data: err });
            } else {
...
app.post("/getgamesetting", (req, res) => {
    ...
    db.query(`SELECT * FROM updatewinner WHERE id='1'`, (err, result) => {
        if (result) {
            ...
            res.status(200).json({ mess: "Successfully", data: resultArray[0] });
        }
    });
});
...
app.post("/userBalanceUpdate", (req, res) => {
    const { userId, payment, transaction_id } = req.body;
...
app.post("/orders", (req, res) => {
    ...
    const { userName, time, Period, cardtype, amount } = req.body;
            ...
            if (resultw) {
                ...
                db.query(`SELECT * FROM wallet WHERE userId='${id}'`, (err, result) => {
                    ...
                    if (parseFloat(resultArrays[0]?.closeBal) >= parseFloat(amount)) {
                        ...
                        res.status(400).json({ message: "balance insufficient" });
                    }
                });
            } else {
            }
...
app.post("/withdralpaymentchack", (req, res) => {
    const tokens = req.headers.authorization.split(" ")[1];
    const {BankId,requestPayment,current_balance,userPassword,fee,channel,payableAmount}=req.body;

    db.query(
        `SELECT * FROM users WHERE userTokan='${tokens}' AND userPassword='${userPassword}'`,
        (err, result) => {
            if (result.length === 0) {
                res.status(400).json({ error: "LPI"});
            } 
            else
            {
    ...
    db.query(
        ...
        (err, result) => {
            if (err) {
                ...
                const rever = resultArray.reverse();
                if (rever?.length == 1) {
                    res.status(200).json({ /* mess: 'Successfully', */ data: "1" });
                } else {
                    res.status(200).json({ mess: "User not found", data: "0" });
                }
            }
        }
    );
    ...
    db.query(`SELECT * FROM deposit`, (err, result) => {
        ...
        db.query(`SELECT * FROM users`, (err, results) => {
            ...
            db.query(`SELECT * FROM withdrawal`, (err, results) => {
                ...
                return res.json({
                    data: { TotalRechageAmount, TotalUserAmount, TotalWithdrawalAmount },
                });
            });
        });
    });
    ...
    db.query(
        ...
        (err, result) => {
            if (err) {
                ...
                res.status(200).json({ mess: "Successfully", data: hst });
            }
        }
    );
});
...
app.post("/show/admin/Payment", (req, res) => {
    db.query(`SELECT * FROM deposit`, (err, result) => {
        ...
        res.status(200).json({ mess: "Successfully", data: rever });
    });
});
...
app.post("/signUp", (req, res) => {
    ...
    db.query(
        ...
        (err, result) => {
            ...
            if(result.length === 0)
            {
             res.status(200).json({ mess: "invalidReferCode" });
            ...
            db.query(
                ...
                (err, result) => {
                    if (err) {
                        ...
                        res.status(200).json({ token: hash, mess: "Successfully" });
                    //get user id
                    ...
                    db.query(
                        ...
                        (err, results) => {
                            if (results) {
                                res
                                    .status(200)
                                    .json({ mess: "Successfully", token: token, data: result });
                            } else {
                                res.status(400).json(err);
                            }
                        }
        ...
        (err, resultw) => {
            if (resultw) {
                ...
                db.query(
                    ...
                    (err, result) => {
                        if (result.length === 1) {
                            res.status(400).json({ error: "ALREADY"});
                        }  
                         else {
                            ...
                            db.query(
                                ...
                                (err, result) => { 
                                    if (result[0].Utr == '') {
                                        ...
                                        res.status(400).json({ error: "ALREADYFILLED"});
...
app.post("/Usercheck", (req, res) => {
    const { userName,userMobile, userNickName, userPassword, userReCode} = req.body
...
db.query(
    ...
    (err, resultw2) => {
        if (resultw2) {
            ...
            {
                res.status(400).json({ error: "InvalidRefCode" });
            }
            else
            {

   //
   res.status(200).json({ otp: true,userName:userName,userMobile:userMobile,userNickName:userNickName,userPassword:userPassword,userReCode:userReCode });
            ...
            //    
              ...
              {
                res.status(400).json({ error: "AlreadyRegAc" });
    ...
    else
    {
        if(isNaN(userMobile))
        {
            res.status(400).json({ error: "ONA" });
        }
        else if(userMobile.length<10 || userMobile.length>10)
        {
            res.status(400).json({ error: "ECN" });
        }
                ...
                db.query(
                    ...
                    (err, result) => {
                        if (result.length <= 2) {
                            res
                                .status(200)
                                .json({ message: "CanProceedBank", Total: result.length });
                        } else {
                            res
                                .status(400)
                                .json({ message: "BankLimitExceed", Total: result.length });
                        }
                    }
                );
            } else {
                        ...
                        if (resultws) {
                            ...
                            if(amount<100 || amount>bonusbalance || isNaN(amount))
                            {
                                ...
                                if(isNaN(amount))
                                {
                                    ...
                                    res.status(200).json({ mess:"AmountNotValid"});
                                }
                                else if(amount<100 )
                                {
                                    res.status(200).json({ mess:"AmountLessthan100"});

                                }
                                else if(amount>bonusbalance)
                                {
                                    res.status(200).json({ mess:"AmountGreaterthanBonus"});
                                         ...
                                         db.query(
                                            ...
                                            (err, resultws) => {
                                                if (resultws) {
                                                    ...
                                                    res.status(200).json({ mess: "okk" ,lvl1amt :level1amount,lvl2amt :level2amount,bonusbal :bonusbalance});
                                         ...
                                         db.query(
                                            ...
                                            (err, resultws) => {
                                                if (resultws) {
                                                    ...
                                                    //console.log("ft :"+fathcount+" | gt :"+gfcount+ "ftlv1 :"+level1amount+" | gtlvl2 :"+level2amount+ " | bonusbbal : "+bonusbalance);
                                                    res.status(200).json({ lvl1p: fathcount ,lvl2p :gfcount ,lvl1amt :level1amount,lvl2amt :level2amount,bonusbal :bonusbalance,code :codes});
...
app.post("/show/rcoptionupi", (req, res) => {
    ...
    {
        if(amount>20000){
            res.status(400).json({ mess: "Max" });
     }
        if(amount < 100){
            res.status(400).json({ mess: "Min" });  }
        if(isNaN(amount) === true){
            res.status(400).json({ mess: "invalidAmount" });  }
    }
   ...
   db.query(`SELECT channelname,upi,Status FROM channelrc WHERE id='${id}'`, (err, resulto) => {
        ...
        if (resulto) {
            db.query(
                ...
                (err, result) => {
                res.status(200).json({channelname:resulto[0].channelname,upi:resulto[0].upi,transactionId:transactionId});
...
app.post("/settingswd", (req, res) => {
    ...
    const {name, limit,times} = req.body;
    if(name == '' && limit == '' && times == '')
    {
        res.status(400).json({ mess: "NE" })  
    }
...
app.post("/edit/settingswd", (req, res) => {
    const {id, name, times,limit  } = req.body;
    db.query(
...
app.post("/edit/admin/paymentDetails", (req, res) => {
    const { Id, paymentHeading, paymentContent, paymentImage, status, showImga } =
        req.body;
    db.query(
    ...
    db.query(
        ...
        (err, resultw) => {
            if (resultw) {
                ...
                const { userId, name, email, phoneNo, subject, message, status } =
                    req.body;
                db.query(
...
app.post("/edit/admin/ticketDetails", (req, res) => {
    const { user, ticketId, name, email, phone, subject, message, status } =
        req.body;
    db.query(
