...
const TableSettingwd = ({baseUrl}) => {
    ...
    var myHeaders = new Headers();
        ...
        fetch(baseUrl + "show/admin/settingwd", requestOptions)
    ...
    const block = (a,b) => {
        ...
        var requestOptions = {
            ...
            body: raw,
            redirect: "follow", };
        fetch(baseUrl+"channelSetwd", requestOptions)
            .then((response) => response.json())
            .then(result => {
    ...
    const addSetting = (e) => {
        e.preventDefault()
        const {name, limit,times } = addsettings
        ...
        fetch(baseUrl+"settingswd", requestOptions)
            .then(response => response.json())
            .then(result => {
    ...
    const editSettings = (val, rowData) => {
        ...
        seteditsettings({
            id: rowData.id, name: rowData.channelname, times: rowData.wdtimes,limit: rowData.wdlimit
        })
    ...
    const editSettingData = (e) => {
        e.preventDefault()
        const {id,name,times,limit} = Editsettings
        var myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json");
        ...
        fetch(baseUrl+"edit/settingswd", requestOptions)
            .then(response => response.json())
            .then(result => {
                if (result.mess === 'Successfully') {
            ...
            <div style={{ padding: '30px', display: "block" }} id="settingTable">
                ...
                <MaterialTable
                    ...
                    columns={[
                        ...
                        { title: 'wdlimit', field: 'wdlimit' },
                        { title: 'wdtimes', field: 'wdtimes' },
                        {
                            title: "Status",
                            editable: true,
                            ...
                            render: (rowData) =>
                              rowData.Status==0?(
                                <Button
                                style={{color:'red',color:'white',background:rowData.Status==0?"red":"green",content:'ddd' }}   
                                ...
                                <Button
                                style={{color:'green',color:'white',background:rowData.Status==0?"red":"green",content:'ddd' }}   
                                onClick={(e) =>{block(rowData.Status,rowData.id)}}
                                >
                ...
                <div style={{ border: "0.4px solid white", borderRadius: "10px", boxShadow: "1px 1px 29px 1px #888888", margin: "30px" }}>
                    <Container style={{ padding: "20px" }}>
                        ...
                        <Form.Group className="mb-3">
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Label>WDlimit</Form.Label>
                                        <Form.Control type="text" name="limit"   value={addsettings.limit} onChange={(e) => handleShow2(e)} />
                                    </Form.Group>
                                    <Form.Group className="mb-3">
                                    <Form.Label>WDtimes</Form.Label>
                                    <Form.Control type="text" name="times"   value={addsettings.times} onChange={(e) => handleShow2(e)} />
                                </Form.Group>
                            <Row>
                                <Col>
            ...
            <div id='editDiv' style={{ display: 'none', border: "0.4px solid white", borderRadius: "10px", boxShadow: "1px 1px 5px 1px #888888", margin: "30px" }}>
                ...
                <Form.Control type="text" name="id" value={Editsettings.id} onChange={(e) => handleShow(e)} />
                        ...
                        <Form.Group className="mb-3">
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Label>WDlimit</Form.Label>
                                        <Form.Control type="text" name="limit" value={Editsettings.limit} onChange={(e) => handleShow(e)} />
                                    </Form.Group>
                                    <Form.Group className="mb-3">
                                        <Form.Label>WDtimes</Form.Label>
                                        <Form.Control type="text" name="times" value={Editsettings.times} onChange={(e) => handleShow(e)} />
                                    </Form.Group>
                            <Row>
                                <Col>
                                    <Button variant="secondary" onClick={() => hideSettings()}>Back</Button>
